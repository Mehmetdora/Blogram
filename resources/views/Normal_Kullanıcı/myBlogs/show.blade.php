                        ...
                        <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                ...
                                <ul class="dropdown">
                                    @if(isset($categories))
                                        @foreach($categories as $category)
                                            <li><a href="{{route('show.blogs',$category->id)}}">{{$category->name}}({{\App\Models\Blog::where('category_id',$category->id)->where('status',1)->count()}})</a></li>
                                        @endforeach
                                    @else
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    @if (isset($categories))
                                        @foreach ($categories as $category)
                                            <li><a
                                                    href="{{ route('show.blogs', $category->id) }}">{{ $category->name }}({{ \App\Models\Blog::where('category_id', $category->id)->where('status',1)->count() }})</a>
                                            </li>
                                        @endforeach
                                    @else
                                        <li><a href="search-result.html">No Category Yet</a></li>
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <hr>
                                    <li class="sign-out"><a>Sign out <br>{{\Illuminate\Support\Facades\Auth::user()->name}}</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="post-entry-alt">
                            ...
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    ...
                                    <span class="d-inline-block mt-1">By <a href="#">{{$blog->profile->profile_name}}</a></span>
