                                        ...
                                        @if (!isset($comment->parent_id))
                                            ...
                                            <div class="comment">
                                                    ...
                                                    @if ($comment->user->id == Auth::user()->id)
                                                        <div class="comment-actions">
                                                            <button class="comment-menu-button"
                                                                aria-label="Comment actions">&#8942;</button>
                                                ...
                                                <button class="reply-button"
                                                    onclick="makeReply({{ $comment->id }},{{ $blog->id }})">Reply</button>
                                                    ...
                                                    @foreach ($comment->replies as $reply)
                                                        @if ($reply->status != 0)
                                                            <div class="reply">
                                                                ...
                                                                <button class="reply-button"
                                                                    onclick="makeReply({{ $reply->id }},{{ $blog->id }})">Reply</button>
                                                            </div>
                                                        @endif
                                                        @if ($reply->replies()->count() > 0)
                                                            @include(
                                                                'Normal_Kullanıcı.blogs.comments.child',
                                                                [
