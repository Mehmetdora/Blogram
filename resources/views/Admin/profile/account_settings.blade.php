            ...
            <div class="col-lg-9" style="margin-left: 20%">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" action="{{route('UpdateAccountSetting')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-12">
                                ...
                                @else
                                    <img src="/img/Default_pfp.jpg" style="width: 36px; height: 36px; object-fit: cover;"
