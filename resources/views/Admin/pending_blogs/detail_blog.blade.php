...
@section('content')
    ...
    <div class="pagetitle" style=" display:flex">
        <a href="@if (url()->previous() == route('list-user-pending_blogs',$blog->user->id)) {{ route('list-user-pending_blogs',$blog->user->id) }}
            @else {{ route('pending_blogs') }} @endif "
        ...
        <div class="a col-sm-2"></div>

        <a href="{{ route('edit-pending_blog', $blog->id) }}" class="btn btn-primary col-sm-2" style="margin-right: 3%">
            Edit Blog
        </a>

        <a onclick="delete_blog({{ $blog->id }})" class="btn btn-danger col-sm-2" style="margin-right: 3%">
            Delete Blog
        </a>

        <a onclick="confirm_blog({{ $blog->id }})" class="btn btn-success col-sm-2">
            Confirm Blog
        </a>
    ...
    <div class="container col-lg-12" style="position: relative;">
        ...
        <div class="post-container"  >
            @if (isset($blog))
                <div class="cover" >
                    <img class="cover-image" src="{{ asset('blog_images/cover_photos/') }}/{{ $blog->cover_photo }}" alt="">
                </div>
                ...
                <hr>
                <label style="font-size: 20px; color:red" >Html Description:</label>
                <div class="post-desc">
                    {{ $blog->description }}
                </div>
            @endif
                    ...
                    @foreach ($comments as $comment)
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-danger"
                                    onclick="delete_comment({{ $comment->id }})">Delete</button></td>
                        </tr>
                    @endforeach
