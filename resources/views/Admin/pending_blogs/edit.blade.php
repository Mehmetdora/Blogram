        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 " data-aos="block" data-aos-delay="200">
                    <form action="{{ route('edited-pending_blog') }}" method="post" id="blogForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row inputs" style="position: relative;">
                            ...
                            <label class="col-6 mb-4 label" style="height:250px; position: relative; " data-toggle="tooltip"
                                ...
                                <img class="rounded "
                                    ...
                                    id="avatar" src="{{ asset('blog_images/cover_photos/') }}/{{ $blog->cover_photo }}" alt="avatar">
                            ...
                            <div class="col-12 mb-3">
                                <textarea class="col-12" name="summery" rows="3" required id="summery">{{ $blog->summery }}</textarea>
                            </div>
