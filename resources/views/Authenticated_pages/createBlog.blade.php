    ...
    <div class="container">
        ...
        <form id="new-blog" action="{{ route('myBlogs.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="editor" name="description" required placeholder="Write your blog post content here">{{ old('description') }}</textarea>
            </div>
                ...
                exec: function(editor) {
                        ...
                        if (userCode) {
                            ...
                            try {
                                ...
                                codeElement.textContent =
                                    userCode; // XSS saldırılarına karşı escape edilmiş bir içerik
                    ...
                    setTimeout(() => {
                        window.onclick = function(event) {
                            if (!modal.contains(event
                                    .target)) { // Modal'ın dışına tıklandıysa
