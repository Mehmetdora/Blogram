...
<body>
    ...
    <div class="banner text-center" style="margin-top: 0">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="content mb-5">
                        ...
                        <p>You can share any questions or suggestions that come to your mind with us.</p>
                    </div>

                    <form method="POST" action="{{route('logined_user_contacted')}}">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="email">Reason For Contact (Required)</label>
                            <input type="text" name="subject" id="subject" class="form-control"
                                placeholder="Advertising" required>
                        </div>
                        <div class="form-group">
                            <label for="message">Your Message Here (Required)</label>
