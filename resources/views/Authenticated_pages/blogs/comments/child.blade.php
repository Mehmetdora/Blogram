@foreach ($replies as $reply)
        ...
        <div class="reply">
            <div class="comment-header">
                ...
                <div class="comment-meta">
                    <a href="{{route('profile.other.show',$reply->user->id)}}" style="color: black"
            ...
            <div class="comment-text">
                <a href="{{route('profile.other.show',$comment->user->id)}}"
                   style="border-radius: 5px; color:rgba(63, 146, 0); padding:0; ">@ {{ $comment->user->name }}
                </a>{{ $reply->content }}
            </div>
    ...
    @if (isset($reply->replies))
        @include('Authenticated_pages.blogs.comments.child', [
